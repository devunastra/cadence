...
export function StatCard({ title, value, sub, accent, valueColor }: StatCardProps) {
  ...
  return (
    <div className="rounded-2xl p-4 flex flex-col h-[120px] min-w-[160px] md:min-w-0 shrink-0 md:shrink" style={{ backgroundColor: 'var(--color-bg)', border: '1px solid var(--color-border)' }}>
